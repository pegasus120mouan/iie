...
<div class="mb-8">
    ...
    <h1 class="text-3xl font-bold text-navy dark:text-white mt-2">{{ $contact->subject }}</h1>
</div>
<div class="bg-white dark:bg-gray-800 rounded-xl p-8 card-shadow max-w-2xl">
    <dl class="space-y-4 text-sm">
        ...
        <div><dt class="text-gray-500">Message</dt><dd class="mt-2 p-4 bg-light dark:bg-gray-700 rounded-lg">{{ $contact->message }}</dd></div>
    </dl>
